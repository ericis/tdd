...
Scenario: Initial State
	...
	Then the display reads "Sorry, the machine is sold out"
...
Scenario: Initial State, Eject Quarter
	...
	Then the display reads "This is not a Slot machine"

Scenario: Initial State, Turn Crank
	Given I have a new gumball machine
	When I turn the crank
	Then the display reads "There are no Gumballs"

Scenario: Initial State, Take Gumball
	Given I have a new gumball machine
	When I try to take a gumball
	Then the display reads "I can't give you what I don't have"